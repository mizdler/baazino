...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { developer_account_id: @developer.developer_account_id, ssid: @developer.ssid, tel: @developer.tel }
    end
  ...
  test "should update developer" do
    patch :update, id: @developer, developer: { developer_account_id: @developer.developer_account_id, ssid: @developer.ssid, tel: @developer.tel }
    assert_redirected_to developer_path(assigns(:developer))
  end
