class GamesController < ApplicationController
  ...
  private
    ...
    def game_params
      #params.require(:game).permit(:game_name, :version, :create_date, :release_date, :description, :developer_id, :genre_id, :review_id, :price, :install_file, :platform_id, :support_version, :cover_photo, :downloads_num, :review_attributes, :video_attributes)
